...
const RideStart: () => Node = ({ navigation, route }) => {
  //Data of Color
  ...
  //End
  //console.log(MyRideDetails?.idRaces);
  //Time
  let date = new Date()
  ...
  React.useEffect(() => {
    ...
    fetch(
      `https://prumad.com/API/index2.php?GETDETAILSRACES=${MyRideDetails[0]?.idRaces}`,
      requestOptions,
    )
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => {
                ...
                fetch(
                  `https://prumad.com/API/index2.php?CourseStartCustomers=${MyRideDetails[0]?.idRaces}`,
                  requestOptions,
                )
