...
const DetailSecurite: () => Node = ({ navigation, route }) => {
  ...
  function savePrivacy() {
    ...
    fetch(
      'http://prumad.com/API/index2.php?insertNumberPrivate',
      requestOptions,
    )
      .then(response => response.json())
      .then(result => {
        console.log(result)
        navigation.navigate('Securite', {
          u_dataV: u_dataV,
          timestamp: timestamp,
        })
      })
        ...
        <View style={[{ margin: 20 }]}>
          ...
          >
            <View>
              ...
              <Text
                style={{ alignSelf: 'center', width: 50, textAlign: 'center' }}
              >
                Police secours
              </Text>
            </View>
          ...
          <View>
            <View>
              <TextInput
                ...
                placeholder="Numero de confiance 1"
              />
            </View>
            ...
            <View>
              <TextInput
                ...
                placeholder="Numero de confiance 2"
              />
            </View>
            <View style={{ borderBottomWidth: 1, borderColor: 'black' }} />
            ...
            <View>
              <TextInput
                value={numberThree}
                style={{ height: 50 }}
                onChangeText={val => setnumberThree(val)}
                placeholder="Numero de confiance 3"
              />
            </View>
          </View>
          <Text />
