...
const ResultDriversT: () => Node = ({navigation, route}) => {
  ...
  function getAlert(){
      ...
      fetch(`https://prumad.com/API/index2.php?AlertAll=${Fr.Tav.toLowerCase()}&currentUserID=${u_data?.u_data?.id}` , requestOptions)
...
const onRefresh = () => {
  ...
  function CourseStart(id){
    ...
    if(MyRideFetch.length > 0){
      sendNotif();
      console.log("==============>");
      navigation.navigate('RideStartT',{u_data:u_data,MyRideDetails:MyRideFetch,timestamp:new Date().getTime()});
    }
  }
  //CourseStart(14)
      ...
      <Modal
        ...
        <View style={Generalstyle.centeredView}>
          <View style={Generalstyle.modalView}>
            ...
            />
            <Text
            onPress={() => {navigation.navigate('Courses');setModalVisible(!modalVisible);}}
              style={[
                    ...
                    fetch("https://prumad.com/API/?insertRaceAdd", requestOptions)
                      ...
                      .then(result => {
                        ...
                        if(result?.status == 406){
                          ...
                          navigation.navigate('ResultDriversT',{u_data: u_data , WAY: WAY,WAYG : '' , timestamp: new Date().getTime()})
