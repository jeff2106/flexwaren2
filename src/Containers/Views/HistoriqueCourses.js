...
export default function HistoriqueCourses({ navigation, route }) {
  ...
  const [defaultMaps, setDefaultMaps] = React.useState({
    latitude: 37.771707,
  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View style={styles.container}>
        <TouchableOpacity
          onPress={() => navigateAndSimpleReset('Index')}
          style={{ margin: 20 }}
        >
        ...
        <View style={{ height: 'auto', width: '90%', alignSelf: 'center' }}>
          ...
          {MyHistorique?.map((item, index) => (
            <TouchableOpacity
              key={index}
              onPress={onPress}
              onPressIn={() => sethistoriqueSelected(item)}
              style={{
              ...
              >
                <View>
                  ...
                  <Text>
                    ...
                    {item?.state == 'start' && 'En cours'}{' '}
                    {item?.state == 'end' && 'Terminer'}
                  </Text>
                </View>
                <View>
                  <View
                  ...
                  >
                    <Text style={{ color: 'black' }}>
                      {item?.driverData?.numberMatricles}
                    </Text>
                  </View>
                  <Image
                    style={[
                      { resizeMode: 'contain', width: 80, alignSelf: 'center' },
                    ]}
        ...
        <BottomSheet2 ref={ref}>
          <View
            style={{
              ...
              borderWidth: 2,
              backgroundColor: '#B0E9B3',
              borderColor: Colors.GreenLignt_BG.backgroundColor,
              borderRadius: 20,
              paddingVertical: 10,
          ...
          >
            ...
            >
              ...
              >
                <MapViewDirections
                  ...
                  destination={{
                    latitude: parseFloat(historiqueSelected?.whereYouGoingLat),
                    longitude: parseFloat(historiqueSelected?.whereYouGoingLng),
                  }}
            ...
            >
              ...
              >
                Course à {historiqueSelected?.date?.split(' ')[1]}
              </Text>
              <View style={{}}>
                <View
                  style={{
                ...
                >
                  <Text style={{ color: 'black' }}>
                    {historiqueSelected?.driverData?.numberMatricles}
                  </Text>
                </View>
                <Image
                  style={[
            ...
            >
              <Text style={{ color: 'black' }}>
                {historiqueSelected?.whereYouAre}
              </Text>
            </View>
            <View
              style={{
            ...
            >
              <Text style={{ color: 'black' }}>
                {historiqueSelected?.whereYouGoing}
              </Text>
            </View>
            <View
              style={{
            ...
            >
              ...
              >
                ...
                <Text style={{ color: 'black' }}>
                  {historiqueSelected?.driverData?.fullName}
                </Text>
              </View>
              <View
                style={{
              ...
              >
                ...
                <Text style={{ color: 'black' }}>
                  {historiqueSelected?.driverData?.carBrand}
                </Text>
              </View>
            </View>
          </View>
