...
const PaymentConfirmation: () => Node = ({ navigation, route }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <TouchableOpacity
        onPress={() => navigation.navigate('PaymentMethode')}
        style={{ margin: 20 }}
      >
      ...
      >
        Assurez-vous bien que le contact utilisé pour le paiement par mobile
        money est bien le votre
      </Text>
    </SafeAreaView>
  )
}
