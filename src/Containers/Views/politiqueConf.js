...
/* === Notifications ====*/
  return (
    ...
    <View style={[{margin:20,flexDirection:'row',marginTop:50}]}>
      ...
      <Text style={[{margin:20,fontSize:15, opacity:0.7,color:"black"}]}>En sélectionnant J'accepte ,ci-dessous, vous acceptez les conditions générale et vous reconnaissez avoir lu la Déclaration de confidentialité. J'ai au moins 18 ans </Text>
