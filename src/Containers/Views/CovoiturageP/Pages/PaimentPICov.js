    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
      <View style={{ flex: 1 }}>
          ...
          <TextInput
            ...
            onBlur={() => {
              if (Price < 5000) {
                ...
                Alert.alert(
                  'Message',
                  'Le montant ne peux être inferieur à 5000',
                )
              }
            }}
          />
        ...
        <WebView
          ...
          source={{
            uri: `https://prumad.com/API/cinetpay-abonnementCovoiturage.php?amout=${Price}&idUser=${u_data?.id}&methodPayment=MobileMoney&timestamp=${timestamp}j&dateStart=${StartAbonnement}&dateEnd=${EndAbonnement}`,
          }}
        />
        <Text />
