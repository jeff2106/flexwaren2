  ...
  return (
    <View style={styles.container}>
      ...
      >
        <MapView.Marker
          coordinate={{
            longitude: Number(CustomersAvailableData?.whereYouGoingLng),
            latitude: Number(CustomersAvailableData?.whereYouGoingLat),
          }}
        >
          <Image
            style={{
        ...
        <MapViewDirections
          ...
          destination={{
            longitude: CustomersAvailableData?.whereYouGoingLng,
            latitude: CustomersAvailableData?.whereYouGoingLat,
          }}
      ...
      >
        ...
        <View>
          ...
          >
            {CustomersAvailableData?.whereYouGoing.split(' ')[0]}
          </Text>
        ...
        >
          ...
          <View>
            <Text style={{ fontSize: 20, color: 'black', textAlign: 'center' }}>
              {Hourse} min & {Kilometers} m
            </Text>
          </View>
          <TouchableOpacity
            onPress={() =>
              Linking.openURL(`tel:${CustomersAvailableData?.numberCustomers}`)
            }
            style={[
              Generalstyle.shadow,
              Colors.White_BG,
          ...
          >
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                fetch(
                  `https://prumad.com/API/index2.php?CancelRide=${CustomersAvailableData?.uidCustomers}`,
                  requestOptions,
                )
                  .then(response => response.json())
                  .then(result => {
