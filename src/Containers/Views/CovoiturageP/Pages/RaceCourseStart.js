...
const RaceCourseStart: () => Node = ({navigation,route}) => {
  ...
  console.log(CustomersAvailableData?.id);
    ...
    <View style={styles.container}>
      <TouchableOpacity style={[{position:'absolute',top:10,zIndex:4}]} onPress={() => navigation.openDrawer()}> 
        ...
        />
          ...
          <View style={{flexDirection:'row',position:'absolute',top:20,alignSelf:'center',backgroundColor:'white',width:'40%',padding:20,alignItems:'center',height:'auto',justifyContent:'space-between',borderRadius:30}}>
        ...
        
        {
          ...
          <View style={{flexDirection:'row',justifyContent:'space-between',alignItems:'center',paddingHorizontal:20,width:'100%'}}>
              ...
              <View>
                  <Text style={{fontSize:20,color: "black",textAlign:'center'}}>10 min & 200 m</Text>
              </View>
              <TouchableOpacity style={[Generalstyle.shadow,Colors.White_BG,{height:50,width:50,justifyContent:'center',alignItems:'center',borderRadius:100}]} onPress={() => alert("call number")}> 
          ...
          <Text/>
          {
            ...
            <View style={{alignSelf:'center',justifyContent:'center',alignItems:'center'}}>
                <TouchableOpacity style={[Generalstyle.shadow,Colors.White_BG,{height:50,width:50,justifyContent:'center',alignItems:'center',borderRadius:100}]} onPress={() => navigation.navigate('AccueilCovoiturageP')}> 
        ...
        <TouchableOpacity onPress={() => navigation.navigate('RaceInPending')} style={[Generalstyle.shadow,Colors.White_BG,{height:40,width:'80%',justifyContent:'center',alignItems:'center',borderRadius:100},Colors.GreenLignt_BG]}> 
