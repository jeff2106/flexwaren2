/**
* Sample React Native CoursesEnd
...
const CoursesEnd: () => Node = ({navigation, route}) => {
...
<View style={[{height: windowHeight, flex: 1}]}>
    ...
    <Text style={{fontWeight:'bold',color:'black',textAlign:'center',fontSize:19}}>VOYAGE TERMINÉ</Text>
    <Text style={{fontWeight:'bold',color:'black',textAlign:'center',fontSize:19}}>Vous êtes arrivé(e)</Text>
