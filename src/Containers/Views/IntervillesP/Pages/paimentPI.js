...
const PaimentPI: () => Node = ({navigation, route}) => {
  ...
  //End
    ...
    channel.bind('AbonnementIntervilles', function(data) {
      console.log(data);
        ...
        <View
          ...
          <View style={Generalstyle.modalView}>
            ...
            <Text
              ...
              Votre abonnement viens d'être mis à jour
            </Text>
            <TouchableOpacity onPress={() => {
          setModalVisible3(!modalVisible3);
          navigation.navigate('Courses',{u_data: u_data , timestamp: timestamp})
