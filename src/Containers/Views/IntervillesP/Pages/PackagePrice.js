...
export default function PackPrice({navigation,route}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View
        ...
        onPress={() => { navigation.navigate('PaimentPI',{methodName: 'Mobile Money',title: '',u_data:u_data , timestamp: new Date().getTime(), PackagePrice: PackagePrice})}}>
