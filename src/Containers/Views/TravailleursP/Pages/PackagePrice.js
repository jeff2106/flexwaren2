...
export default function PackPriceT({navigation,route}) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View
        ...
        onPress={() => { navigation.navigate('PaimentPIT',{methodName: 'Mobile Money',title: '',u_data:u_data , timestamp: new Date().getTime(), PackagePrice: PackagePrice})}}>
