...
const NAlertT: () => Node = ({navigation, route}) => {
  ...
  function sendNewAlert(){
    ...
    formdata.append("whereAreYouGoing",whereAreYouGoing.toLowerCase());
    ...
    formdata.append("raceType", Fr.Tav);
    ...
    .then(result => {
      ...
      navigation.navigate('CoursesT',{u_data: u_data,timestamp: new Date().getTime()});
    })
