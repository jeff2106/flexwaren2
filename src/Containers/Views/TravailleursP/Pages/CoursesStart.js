/**
* Sample React Native CoursesStartT
...
const CoursesStartT: () => Node = ({navigation, route}) => {
...
<View style={[{height: windowHeight, flex: 1}]}>
    ...
    <Text style={{fontWeight:'bold',textAlign:'center',fontSize:19}}>En route ...</Text>
    <View style={{height: 50}} />
    <Image
        ...
        />
        <View style={{height: 50}} />
    <Text style={{fontWeight:'bold',textAlign:'center'}}>Bonne route !!!</Text>
    ...
    <View
            ...
            />
                    ...
                    <Text style={{textAlign:'center',fontSize:12}}>Contact de</Text>
                    <Text style={{textAlign:'center',fontSize:12}}>confiance</Text>
              </View>
              <View>
              <TouchableOpacity style={[Generalstyle.shadow,{
                  width:50,
            ...
            />
              ...
              <Text style={{textAlign:'center',fontSize:12}}>Numéros</Text>
                    <Text style={{textAlign:'center',fontSize:12}}>d'urgence</Text>
              </View>
            </View>
<View style={{height: 50}} />
    <View>
        ...
        onPress={() => {
            var requestOptions = {
                ...
                .then(result => {
                  console.log(result)
                  navigation.navigate('CoursesEndT',{u_data:u_data,timestamp:new Date().getTime()});
                })
