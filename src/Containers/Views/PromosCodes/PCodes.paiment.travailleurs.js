  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{flex: 1,backgroundColor: 'white'}}>
        ...
        <WebView
        style={{flex: 1}}
        source={{ uri:`https://prumad.com/API/cinetpay-promo-travailleurs.php?amout=500&idUser=${u_data?.id}&methodPayment=MobileMoney&timestamp=${timestamp}&dateStart=${StartAbonnement}&dateEnd=${EndAbonnement}` }} />
        <Text/>
        <Text/>
