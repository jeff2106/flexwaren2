    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        <View style={{ position: 'absolute', bottom: '7%', left: 0, right: 0 }}>
          ...
          <TouchableOpacity
            onPress={() => /* NmberVerifL1 sendLocalNotificationWithSound() */ {
              hasAlreadyConnectState?.status !== 200
                ? navigation.navigate('NmberVerifL1')
        ...
        <View style={styles.modalView}>
          <Text
            style={[
              styles.modalText,
              {
                color: Colors.darkGreen_BG.backgroundColor,
                fontSize: 20,
                fontWeight: 'bold',
              },
            ]}
          ...
          <View>
            <View>
              <Image
                ...
                source={{
                  uri: `data:image/jpeg;base64,${hasAlreadyConnectState?.u_data?.photoProfil}`,
                }}
              />
            </View>
            <Text
            ...
            >
              {hasAlreadyConnectState?.u_data?.fullName}
            </Text>
          </View>
          <Pressable
            ...
            onPress={() => {
              setModalVisible(!modalVisible)
              signUp(hasAlreadyConnectState, 'password')
            }}
          >
